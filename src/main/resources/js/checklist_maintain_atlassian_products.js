...
function isValidUrl($container, fileId, error) {
    var $field = $container.find(fieldId);
...
Confluence.Blueprint.setWizard('net.bytebrand.confluence.plugins.checklist_maintain_atlassian_products.checklist_maintain_atlassian_products:blueprint-item', function (wizard) {
    wizard.on('submit.wizardMainPage', function (e, state) {
        ...
        var urlValid = isValidUrl($container, "#future-url", AJS.I18n.getText("checklist.wizard.blueprint.form.field.url.validation.required"));
